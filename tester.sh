...
if ./philo 1 800 200 200 | grep dead >/dev/null
then
    echo -e "${GREEN}OK"
else
    echo -e "${RED}KO"
...
if timeout 10 ./philo 5 800 200 200 | grep dead >/dev/null
then
    echo -e "${RED}KO"
else
    echo -e "${GREEN}OK"
...
if ./philo 5 800 200 200 7 | grep dead >/dev/null
then
    echo -e "${RED}KO"
else
    echo -e "${GREEN}OK"
...
if timeout 10 ./philo 4 410 200 200 | grep dead >/dev/null
then
    echo -e "${RED}KO"
else
    echo -e "${GREEN}OK"
...
if ./philo 4 310 200 100 | grep dead >/dev/null
then
    echo -e "${GREEN}OK"
else
    echo -e "${RED}KO"
...
if timeout 10 ./philo 2 400 200 200 | grep dead >/dev/null
then
    echo -e "${RED}KO"
else
    echo -e "${GREEN}OK"
